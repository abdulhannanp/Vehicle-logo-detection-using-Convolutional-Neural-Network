...
# Convolution
classifier.add(Conv2D(32, (11, 11), input_shape = (64, 64, 3), activation = 'relu'))
# Pooling
...
classifier.fit_generator(training_set, steps_per_epoch = 10, epochs = 10, validation_data = test_set, validation_steps = 2000)
